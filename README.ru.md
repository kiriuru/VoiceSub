...
- Windows 10/11 x64
- **Google Chrome** (или Edge для smoke) — system dependency для Web Speech
...
| Текст в OBS не исчезает после TTL/Stop | Обновите сборку; пустой `overlay_update` должен очищать экран (`disposeRenderContainer`, overlay `?v=20260610a`) |
