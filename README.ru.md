...
1. Установите **VoiceSub** из `VoiceSub_0.5.2_x64-setup.exe` (или последней сборки в папке релиза; разработчикам: `build-release-msi.bat` → `build-release.ps1`).
...
Активная разработка: Parakeet как опциональный **sidecar-модуль** после 0.5.x. Текущая patch-линия **`0.5.2`** — см. [CHANGELOG](./docs/CHANGELOG.md). Roadmap: `docs/plans/voicesub_roadmap.ru.md`.
...
Версия: `voicesub-types::PROJECT_VERSION` = **`0.5.2`**.
