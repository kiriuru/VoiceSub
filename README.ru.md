...
1. Установите **VoiceSub** из `VoiceSub_0.5.5_x64-setup.exe` (или последней сборки в папке релиза; разработчикам: `build-release-msi.bat` → `build-release.ps1`).
...
Текущая patch-линия **`0.5.5`** — см. [CHANGELOG (RU)](./docs/CHANGELOG.md) / [(EN)](./docs/CHANGELOG.en.md).
...
Версия: `voicesub-types::PROJECT_VERSION` = **`0.5.5`**.
