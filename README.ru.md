...
1. Установите **VoiceSub** из `VoiceSub_0.5.3_x64-setup.exe` (или последней сборки в папке релиза; разработчикам: `build-release-msi.bat` → `build-release.ps1`).
...
Текущая patch-линия **`0.5.3`** — см. [CHANGELOG](./docs/CHANGELOG.md).
...
Версия: `voicesub-types::PROJECT_VERSION` = **`0.5.3`**.
