...
class ParakeetLifecycleTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_stale_result_is_ignored_after_generation_change(self) -> None:
        ...
        ignored = int(self.runtime._metrics_controller.metrics.asr_stale_results_ignored or 0)  # noqa: SLF001
        dropped = int(self.runtime._metrics_controller.metrics.stale_partial_jobs_dropped or 0)  # noqa: SLF001
