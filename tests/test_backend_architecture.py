...
class BackendArchitectureTests(unittest.TestCase):
    ...
    def test_runtime_and_config_refactor_entrypoints_exist(self) -> None:
        expected_paths = [
            ...
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_asr_pipeline.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_parakeet_transcript_segment.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_asr_realtime_settings.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "asr_diagnostics_assembler.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "partial_emit_coordinator.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_asr_vad_tuning.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_asr_recognition_processing.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "browser_worker_transcript_builders.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_browser_worker_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_remote_ingress_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_diagnostics_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_local_asr_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_lifecycle_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "runtime_orchestrator_state_metrics_mixin.py",
            PROJECT_ROOT / "backend" / "core" / "runtime" / "local_asr_hallucination_filter.py",
